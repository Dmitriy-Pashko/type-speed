...
import { useSystem } from "../hooks/useTypeTest";
...
// TODO change any and remove svg to separate file
const StyledSvg = styled.svg`
  width: 50px;
  height: 50px;
  color: ${({ theme }: { theme: any }) => theme.text.title};
`;

const Header = () => {
  // TODO add restart from hook here
